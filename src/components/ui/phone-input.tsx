...
const InputComponent = React.forwardRef<HTMLInputElement, React.ComponentProps<"input">>(
  ({ className, ...props }, ref) => (
    <Input className={cn("rounded-e-lg rounded-s-none h-12 focus-visible:ring-0", className)} {...props} ref={ref} />
  )
)
    ...
    >
      <PopoverTrigger asChild>
        <Button
          type="button"
          variant="outline"
          className="flex gap-1 rounded-e-none rounded-s-lg px-3 focus:z-10 border border-neutral-600  hover:border-neutral-600 focus:border-ring border-r-0 focus-visible:ring-0"
          disabled={disabled}
        >
